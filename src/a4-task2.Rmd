...
- counts of juvenile snowshoe hares have decreased dramatically compared to 1999. 
- On average, male juvenile snowshoe hares weigh more than juvenile females (the difference in significant, but the effect size is small). 
- Hind foot length appears loosely linearly related to weight (the relationship is significant, with Pearson's r showing a moderate association between variables). However, diagnostic plots show that assumptions regarding residuals may be violated 
